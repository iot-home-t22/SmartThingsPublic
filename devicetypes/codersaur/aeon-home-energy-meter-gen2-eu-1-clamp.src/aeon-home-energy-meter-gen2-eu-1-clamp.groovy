 ...
 *
 *  Name: Aeon Home Energy Meter (GEN2 - EU - 1 Clamp)
 *
 ...
 *
 *   2019-03-19: v1.03.1:
 *    - Swapping Pound for Euro symbol
 *
 *   2017-03-02: v1.03:
...
metadata {
	...
	preferences {
    	section {
			...
			input "configCostPerKWH", "string", title: "Energy Cost (€/kWh)", defaultValue: "0.2", required: true, displayDuringSetup: false
    	}
